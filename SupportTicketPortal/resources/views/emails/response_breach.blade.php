...
<body>
    <div class="wrapper">
        ...
        <div class="header">
            ...
            <p class="header-title">SLA Response Breached</p>
        </div>
        ...
        <div class="body">
            ...
            <p class="greeting">
                This ticket has exceeded its SLA response time and is now overdue.
                Immediate action is required. Please review, respond, or assign
                it to an available agent without delay.
            </p>
            ...
            {{-- CTA Button --}}
            <div class="cta">
                <a href="{{ url('/tickets/' . $ticket->id) }}">Review & take action →</a>
            </div>

            {{-- Blockquote note --}}
            <p class="note">
                Ensure this ticket is assigned to the responsible agent and a response is provided immediately.
            </p>
